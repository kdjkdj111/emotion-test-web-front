            ...
            <div className="font-studio flex h-full w-full max-w-[1600px] mx-auto bg-white shadow-2xl">
                ...
                <div className="w-[62%] border-r border-slate-200 p-6 flex flex-col bg-slate-50 h-full">
                        ...
                        <div className="flex items-center gap-3">
                            ...
                            <div>
                                <div className="flex items-center gap-2">
                                    <h1 className="text-xl font-extrabold text-slate-800 tracking-tighter">움직이는 이모티콘</h1>
                                    <span className="px-1.5 py-0.5 bg-indigo-100 text-indigo-600 text-[9px] font-bold rounded-md uppercase">GIF/APNG</span>
                                </div>
                                <p className="text-[10px] font-bold text-slate-400 mt-0.5">360 x 360 px | 최대 24개 구성을 확인하세요.</p>
                            </div>
                        </div>
                    </header>
                    ...
                    >
                        ...
                        <p className={`font-bold text-sm transition-colors ${isDragging ? 'text-indigo-700' : 'text-slate-700'}`}>
                            ...
                            >
                                {previews[i] ? (
                                    <>
                                        ...
                                        <div className="absolute -top-2.5 -left-2.5 bg-indigo-500 text-white text-[9px] font-extrabold rounded-full w-6 h-6 flex items-center justify-center shadow-md z-10 border-2 border-white">{i + 1}</div>
                ...
                <div className="w-[38%] bg-white p-8 flex flex-col h-full shadow-2xl z-10">
                    <div className="flex items-center justify-between mb-6">
                        <div>
                            ...
                            <p className="text-[10px] text-slate-400 font-bold mt-0.5 uppercase tracking-wider">Frame & Frame Analysis</p>
                        </div>
                                    ...
                                    return (
                                        ...
                                        >
                                            <div className="flex items-center space-x-2.5 truncate text-slate-700 font-bold">
                                                <span className="text-indigo-500 font-extrabold w-4 text-[12px]">{i + 1}</span>
                                                <span className="truncate text-[12px]">{item.name}</span>
                                            </div>
                                            <div className="flex items-center space-x-1.5">
                                                {res.status === 'LOADING' && <div className="w-3.5 h-3.5 border-2 border-indigo-500 border-t-transparent rounded-full animate-spin"></div>}
                                                {res.status === 'SUCCESS' && <span className="text-indigo-500 font-bold text-[9px] bg-indigo-50 px-1.5 py-0.5 rounded-md border border-indigo-100">통과</span>}
